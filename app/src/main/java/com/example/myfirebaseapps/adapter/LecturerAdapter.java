...
public class LecturerAdapter extends RecyclerView.Adapter<LecturerAdapter.CardViewViewHolder>{
    ...
    public LecturerAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lecturer_adapt, parent, false);
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder{
        ...
        CardViewViewHolder(View itemView) {
            super(itemView);
            lbl_name = itemView.findViewById(R.id.lect_adapt_name);
            lbl_gender = itemView.findViewById(R.id.lect_adapt_gender);
            lbl_expertise = itemView.findViewById(R.id.lect_adapt_expertise);
        }
    }
}