...
import com.example.myfirebaseapps.adapter.EnrollAdapter;
...
public class Frag2 extends Fragment {
    ...
    private void showData(ArrayList<Course> listCourse){
        rv.setLayoutManager(new LinearLayoutManager(Frag2.this.getActivity()));
        EnrollAdapter enrollAdapter = new EnrollAdapter(Frag2.this.getActivity());
