...
public class LectDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lecturer_detail_act);
        ...
        dialog = GlobalVariable.loadingDialog(LectDetail.this);
        ...
        bar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LectDetail.this, LecturerData.class);
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(LectDetail.this)
                        .setTitle("Confirm")
                        .setIcon(R.mipmap.splash_bg_background)
                                    ...
                                    public void run() {
                                        ...
                                        mDatabase.child(lecturer.getId()).removeValue(new DatabaseReference.CompletionListener() {
                                            ...
                                            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                                Intent in = new Intent(LectDetail.this, LecturerData.class);
                                                in.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                Toast.makeText(LectDetail.this, "Delete success!", Toast.LENGTH_SHORT).show();
                                                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(LectDetail.this);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                v.startAnimation(klik);
                Intent in = new Intent(LectDetail.this, AddLecturer.class);
    ...
    public void onBackPressed() {
        Intent intent;
        intent = new Intent(LectDetail.this, LecturerData.class);
